...
def gen():
    # cap=cv2.VideoCapture("rtsp://brighten:brighten0701@210.90.113.82:6666/stream1")
    cap=cv2.VideoCapture("rtsp://dogcam:blueberry19@errong.iptimecam.com:21040/stream_ch00_0")
